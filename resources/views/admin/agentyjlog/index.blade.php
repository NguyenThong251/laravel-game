...
@section('title', 'Agent Commission Record List')

@section('content')
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h4>Agent Commission Record List</h4>
            ...
            <form action="" method="get" id="searchForm" name="searchForm">
                <div class="row">
                    ...
                    'list' => [
                        ...
                        'agent_id' => ['name' => 'Choose an agent','type' => 'select','data' => \App\Models\Member::getAgentArray()]
                        ]
                    ])
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th width=100 style="min-width: 100px;">Modification time</th>
