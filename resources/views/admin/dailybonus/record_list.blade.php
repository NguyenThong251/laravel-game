...
$record_list = [
	...
	'bonus_money' => ['name' => 'Sign-in reward amount','type' => 'text','is_show' => true],
	'serial_days' => ['name' => 'Consecutive sign-in days','type' => 'text','is_show' => true],
	'total_days' => ['name' => 'Cumulative sign-in days','type' => 'text','is_show' => true],
	'type' => ['name' => 'type','type' => 'select' ,'is_show' => true,'data' => 'platform.daily_bonus_type'],
	'state' => ['name' => 'state','type' => 'select', 'is_show' => true,'data' => 'platform.daily_bonus_state'],
]
@endphp
