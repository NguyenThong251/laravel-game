...
// $title = $isUpdated?"Sign in Modify":"Sign inAdded"
@endphp
        ...
        <div class="card-body">
            ...
            <form method="post" class="form-horizontal"
                ...
                <div class="form-group" id="serial" 
                    ...
                    >
                    <label class="col-sm-2 control-label required">Consecutive sign-in days</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="serial_days" placeholder="Please enter Consecutive sign-in days"
                ...
                <div class="form-group" id="total"
                    ...
                    @else style="display:none" @endif>
                    <label class="col-sm-2 control-label required">Cumulative sign-in days</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="total_days" placeholder="Please enter Cumulative sign-in days"
