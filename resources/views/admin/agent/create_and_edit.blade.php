...
@php
$isUpdated = isset($model->id);
$title = $isUpdated?"Proxy Modified:"ProxyAdded";
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" class="form-horizontal"
                ...
                {{--
                <div class="form-group">
                    <label class="col-sm-2 control-label required">Proxy Links</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="agent_uri" placeholder="Please enter Proxy Links"
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Proxy Links prefix</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="agent_uri_pre" placeholder="Please enter Proxy Links prefix"
