                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            {{--<th style="min-width: 160px">上Second-rate登录IP/真实地址</th>--}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    {{-- 如果是传统代理模式，没有上级账号的会员才能设置代理 || 全民代理模式，所有账号都可以设置上级 --}}
                                    ...
                                    {{--
                                    <a class="btn btn-xs btn-default" data-url href="{{ route('admin.agents.assign',['member' => $item->id]) }}" data-toggle="tooltip" data-original-title="设为代理">
                                    ...
                                    {{-- 如果是传统代理模式，只有会员才能设置上级账号 || 全民代理模式，所有账号都可以设置上级 --}}
