            ...
            <form action="" method="get" id="searchForm" name="searchForm">
                <div class="row">
                    ...
                    'list' => [
                        ...
                        //'visible_type' => ['name' => '可见type','type' => 'select','data' => config('platform.message_visible_type')],
                        //'send_type' => ['name' => '发送type','type' => 'select','data' => config('platform.message_send_type')]
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    {{-- <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                        data-toggle="tooltip" data-original-title="反馈Details"
                                    ...
                                    {{-- <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                        data-toggle="tooltip" data-original-title="回复Details"
                                    ...
                                    {{-- <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                        data-toggle="tooltip" data-original-title="delete回复"
                                        data-message="Suredelete管理员对该站内信的回复吗"
