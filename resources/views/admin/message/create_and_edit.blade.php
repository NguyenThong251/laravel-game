...
// $title = $isUpdated?"站内信修改":"站内信Added";
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" class="form-horizontal"
                ...
                {{-- <div class="form-group">
                    <label class="col-sm-2 control-label ">上strip消息ID</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="pid" placeholder="Please enter 上strip消息ID"
                ...
                {{-- <div class="form-group">
                    <label class="col-sm-2 control-label required">发送type</label>
                    <div class="col-sm-4">
