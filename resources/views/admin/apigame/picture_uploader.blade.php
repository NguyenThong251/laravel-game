      ...
      <div class="card-body">
          ...
          <form method="post" class="form-horizontal" id="form">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label ">Computer side pictures</label>
              <div class="col-sm-4">
                  <input type="text" name="uploadurl" class="form-control" placeholder="请Upload pictures"
                      value="">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-group">
                  <div class="col-sm-4 col-sm-offset-2">
                      <button class="btn btn-primary" type="button" id="btn-yes">Sure</button>
