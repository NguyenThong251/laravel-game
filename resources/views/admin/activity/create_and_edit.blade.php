        ...
        <div class="card-body">
            ...
            <form method="post" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <span class="help-block">Only activities with uploaded list cover images will be displayed in the activity list</span>
                    </div>
                </div>
                ...
                {{--If the application type is an event hall application, you need to fill in the event hall application information apply-field --}}
                <div class="form-group" id="hall-field" @if($isUpdated && $model->apply_type == App\Models\Activity::APPLY_TYPE_HALL) style="display:block" @else style="display:none" @endif>
                    ...
                    <div class="col-sm-4">
                        <span class="help-block">The default member name is required</span>
                    </div>
                </div>

                {{--Event Hall Cover Image Start--}}
                ...
                {{--Event Hall Cover Image End--}}

                {{--If the application type is to jump to view Details, you need to fill in the jump address--}}
                ...
                {{--
                <div class="form-group">
                    <label class="col-sm-2 control-label">The amount of money required for the activity</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="money" placeholder="Please enter The amount of money required for the activity"
                            value="{{ $isUpdated?$model->money:"" }}" @if(!$isUpdated) required @endif>
                    </div>

                    <label class="col-sm-2 control-label">Gift ratio</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="rate" placeholder="Please enter Gift ratio"
