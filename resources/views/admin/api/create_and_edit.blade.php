...
$title = $isUpdated?"API interface modification":"API interface Added"
@endphp
        ...
        <div class="card-body">
            ...
            <form method="post" class="form-horizontal"
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label required">Interface ID</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="api_id" placeholder="Please enter Interface ID"
                               value="{{ $isUpdated?$model->api_id:"" }}" @if(!$isUpdated) required @endif>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label required">Platform Logo</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="api_name" placeholder="Please enter Platform Logo"
                            value="{{ $isUpdated?$model->api_name:"" }}" @if(!$isUpdated) required @endif>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label required">Platform Description Name</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="api_title" placeholder="Please enter Platform Description Name"
                            value="{{ $isUpdated?$model->api_title:"" }}" @if(!$isUpdated) required @endif>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label ">Interface balance</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="api_money" placeholder="Please enter Interface balance"
                            value="{{ $isUpdated?$model->api_money:"" }}" @if(!$isUpdated) required @else readonly @endif>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label ">Account prefix</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="prefix" placeholder="Please enter Account prefix"
                ...
                @if(request('is_super'))
                    <div class="form-group">
                        <label class="col-sm-2 control-label required">currency</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Supported languages</label>
                        <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label required">Open</label>
                    <div class="col-sm-4">
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res.status == 'success'){
                        ...
                        else btnWrapper.append("<a class='btn btn-default btn-sm' href='"+url+"' target='_blank'>Preview</a>");
                    }
                    e.target.value = "";
                },
                error:function(){
