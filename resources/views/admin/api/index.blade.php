                        ...
                        <tr>
                            <td>
                                <input type="text" class="form-control" name="remote_api_domain-{{ \App\Models\Base::LANG_COMMON }}"
                                    placeholder="例：api.888.com" value="{{ $config['remote_api_domain'] ?? '' }}" />
                            </td>
                            <td>
                                <input type="text" class="form-control" name="remote_api_prefix-{{ \App\Models\Base::LANG_COMMON }}" placeholder="例：9k"
