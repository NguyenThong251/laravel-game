...
return [
    'common' => [
        ...
        'page_notice' => '< chính trị > lưu ý: nhấn vào nút làm mới văn bản bên phải để làm mới trang này',
        ...
        'member_id' => 'Tài khoản thành viên',
        'member_name' => 'Tài khoản thành viên',
        'user_id' => 'Quản trị tài khoản',
        'api_id' => 'Giao diện tài khoản',
        'agent_id' => 'Tài khoản đại lý',
        'top_id' => 'Cấp trên đại diện',
        'game_type' => 'Các loại trò chơi',
        'deleted' => 'Đã xóa',

        'login_notice' => 'Đăng nhập nhắc nhở',
        'inner' => 'Bên trong',
        ...
        'fix_url' => 'Sửa chữa địa chỉ hình ảnh',
        ...
        'color_header' => 'Cái đầu',
        'color_sidebar' => 'sidebar',
        'no_limit' => "Tối đa",
        'lang_notice' => 'Vì mạch hệ thống liên quan đến nhiều ngôn ngữ/đơn vị tiền tệ, bạn cần chọn "ngôn ngữ/đơn vị tiền tệ" trước khi truy vấn dữ liệu'
    ],
    ...
    'base' => [
        ...
        'save_success' => 'Thành công trong việc cứu',
        ...
        'batch_add_success' => 'Thêm thành công với số lượng lớn',
    ...
    'btn' => [
        ...
        'batch_add' => 'Mới được bổ sung theo lô',
        'search' => 'Tìm kiếm',
        'reset' => 'Đặt lại',
        'edit' => 'Biên tập',
        'detail' => 'Chi tiết',
    ...
    'index' => [
        'title' => 'Trang đầu',
        'today_register' => 'Số người đăng ký vào ngày hôm nay',
        'today_free' => 'Chi phí tiếp thị ngày nay',
        'today_bet' => 'Người chơi đặt cược vào ngày hôm nay',
        'today_game_profit' => 'Tổng doanh thu trò chơi ngày nay',
        ...
        'drawing_title' => 'Số lượng rút tiền',

		'site_domain_required' => 'Hãy chắc chắn rằng【Cấu hình hệ thống - Tên miền chính của trang web】Điền URL trước khi thay thế',
        'app_url_required' => 'Hãy đảm bảo rằng nó nằm trong thư mục gốc của trang web".env"Tài liệu củaAPP_URLĐiền vào trường với URL đã thay thế',
    ...
    'member' => [
        'field' => [
            ...
            "gender" => "Giới tính",
            "invite_code" => "Mã mời",
            "qk_pwd" => "Rút tiền mật khẩu",
            "money" => "Số dư tài khoản trung tâm",
            "fs_money" => "Số dư tài khoản nước trở lại",
            ...
            "is_in_on" => "Cho dù tài khoản nội bộ",
            "top_id" => "Id đại diện cấp cao.",
            "agent_id" => "Id ủy nhiệm.",
            "level" => "Cấp VIP.",
            "is_demo" => "Thử tài khoản",

            "is_online" => "Là trực tuyến",
        ...
        'index' => [
            ...
            'last_ip' => 'Địa chỉ IP cuối cùng đăng nhập.',
            'title_modify_money' => 'Thay đổi số dư thành viên',
            'title_assign_agent' => 'Thiết lập như một đặc vụ',
            'title_assign_member_agent' => 'Thiết lập tài khoản [:name] như một đại lý',
            'title_modify_top' => '4/5000
Phân phối các đại lý',
            'title_modify_member_top' => 'Đại lý cấp trên của tài khoản [:name]'
        ],
        'edit' => [
            'title_edit' => 'Thành viên sửa đổi',
            'title_create' => 'Thành viên mới',
            'is_tips_on_notice' => 'Và mỗi lần người chơi đăng nhập, có một âm thanh gợi ý',
            'is_in_on_notice' => 'Thành viên thắng hay thua sau khi mở không được ghi nhận thống kê'
        ],

        'member_apis' => [
            'title' => 'Đường dây giao diện thành viên',
            'api_title' => 'Giao diện tên',
            'money' => 'Tôi hiểu',
            'null' => 'Không mở',
            'refresh' => 'Làm sạch số dư giao diện',
            'recycle' => 'Tái chế bằng một cú nhấp chuột',
        ],

        'modify_money' => [
            'title' => 'Thành viên giới hạn sửa đổi',
        ...
        'modify_top' => [
            'notice' => '<strong>Lưu ý: tài khoản này không được thiết lập trước khi điểm trở lại, sau khi cấp trên sẽ tự động cấp điểm điểm trở lại theo tài khoản cấp trên được chỉ định'
        ],

        'money_report' => [
            'title' => 'Báo cáo tài chính',
            'notice' => '<strong>Chú ý: tích cực cho lợi nhuận nền tảng, tiêu cực cho thất bại nền tảng',
            'created_at' => 'Khoảng thời gian',
            'is_agent_and_top_agent' => 'Đại lý/cấp trên',
            'recharge_count' => 'Số tiền gửi',
            'drawing_count' => 'Số lượng rút tiền',
            'recharge_sum' => 'Tổng số tiền gửi',
            'drawing_sum' => 'Tổng số tiền rút ra',
            'total_fs' => 'Tổng số trở về nước',
            'total_dividend' => 'Tổng lợi tức',
            'total_other' => 'Tổng số khác',
            'total_profit' => 'Tổng số lợi nhuận và tổn thất',

            'profit_formula_notice' => 'Tính toán chi phí và công thức và hướng dẫn',
            'profit_formula' => 'Tiền gửi - rút tiền - nước trở lại - lợi tức - còn lại = lợi tức thực tế',
            'yinli' => 'Lợi nhuận：',
            'kuisun' => 'Lôi kéo：'
        ],
        ...
        'msg' => [
            ...
            'offline_success' => 'Thành viên đã được【 :name 】Đá ở tuyến dưới',
    ...
    'agent' => [
        ...
        'index' => [
            ...
            'btn_fd_rate' => 'Điểm chống',
            'title_fd_rate' => 'Cơ quan :name Điểm chống',
    ...
    'user' => [
        'field' => [
            ...
            "is_google_secret" => "Có ràng buộc mã xác minh của Google hay không",
        ],
        ...
        'google' => [
            'first_notice' => 'Đối với ràng buộc đầu tiên, vui lòng sử dụng Google Xác thực APP để quét trực tiếp mã QR, nhập mã xác minh của Google trên điện thoại, sau đó gửi ràng buộc;',
            'reset_notice' => 'Bạn đã liên kết mã xác minh của Google, nếu bạn cần liên kết lại, vui lòng liên hệ với quản trị viên',
            'scan_qrcode' => 'Quét mã ràng buộc',
            'secret_notice' => 'Vui lòng nhập mã xác minh của Google trên điện thoại của bạn sau khi quét mã',
            'submit' => 'Gửi ràng buộc',
    ...
    'apis' => [
        ...
        'index' => [
            'top_title' => 'APICấu hình giao diện cơ bản',
    ...
    'api_game' => [
        ...
        'index' => [
            ...
            'web_pic_notice' => '【Điện tử】Hình ảnh đã phân loại tương ứng với danh sách trò chơiLogo'
        ],
    ...
    'member_agent_apply' => [
        'field' => [
            ...
            "phone" => "Số điện thoại",
            "email" => "Thư điện tử",
            "msn_qq" => "Thông tin liên hệMSN/QQ",
    ...
    'agent_fd_rate' => [
        ...
        'agent' => [
            ...
            'btn_apply' => 'Ứng dụng',
            'title' => 'Thiết lập cơ quan【 :name 】Điểm chống',
        ...
        'msg' => [
            'system_highest_error' => 'Loại trò chơi hệ thống【 :game_type 】Điểm chống nước cao nhất thấp hơn điểm chống nước thấp nhất của loại này, vui lòng kiểm tra',
            'system_lowest_error' => 'Loại trò chơi hệ thống【 :game_type 】Của điểm chống nước thấp nhất cao hơn điểm chống nước cao nhất của loại hình này, kiểm tra',
        ],
    ],
    ...
    'game_record' => [
        ...
        'index' => [
            'btn_send_fd' => 'Trả lại',
            'notice_send_fd' => 'Bạn có chắc chắn về việc phát hành ngược nước của kỷ lục trò chơi không?',
    ...
    'banner' => [
        ...
        'edit' => [
            ...
            'group_notice' => 'Vui lòng điền vào biểu đồ băng chuyền điện thoại di động“mobile1”,PCVui lòng điền vào bản đồ băng chuyền“new1”'
        ]
    ],
    ...
    'activity_apply' => [
        ...
        'bonus' => [
            'top_notice' => '<strong>Chú ý đến：</strong> Số tiền hoạt động được cấp mặc định vào tài khoản chống nước',
    ...
    'recharge' => [
        'field' => [
            "bill_no" => "Số lưu thông giao dịch",
            "member_id" => "Id thành viên",
            "name" => "Chuyển tên",
    ...
    'message' => [
        'field' => [
            ...
            "url" => "Nhảy tới địa chỉ URL.",
            "title" => "Tiêu đề của lá thư trong nhà ga",
    ...
    'member_money_log' => [
        ...
        'notice' => [
            'activity_bonus' => 'Các hoạt động phát【 :title 】Tiền thưởng【 :money Nhân dân tệ】Đối với các thành viên【 :member 】',
            'system_send_fs' => 'Khung thời gian phát hành của quản trị viên【 :time 】Các loại trò chơi【 :game_type 】Ví chống nước đến ví chống nước',
            'drawing_reject' => 'Không thông qua việc rút tiền mặt của các thành viên, số tiền sẽ【 :money Nhân dân tệ】Hoàn trả vào tài khoản thành viên, lý do từ chối：:reason',
            'drawing_counter_fee' => '，Số lượng mã thành viên là【 :ml_money 】,Trừ phí xử lý【 :count_feeNhân dân tệ】',
            'drawing_request' => 'Số tiền rút tiền cuối cùng của thành viên là【 :money 】',
            'get_fs_now' => 'Ngày nhận【 :time 】Trước sự chống nước，Số tiền được【 :money 】，Các loại trò chơi【 :game_type】，Phân phối cho ví chống nước',

            'transfer_in_game' => 'Chuyển sang【 :title 】Trò chơi【 :money Nhân dân tệ】，Khấu trừ số tiền tài khoản',
            'transfer_in_error' => 'Chuyển sang【 :title 】Trận đấu thất bại，Hoàn trả số tiền tài khoản【 :money Nhân dân tệ】',
            'transfer_out_game' => 'Chuyển ra ngoài【 :title 】Trò chơi【 :money Nhân dân tệ】，Tăng số tiền tài khoản'
        ]
    ],
    ...
    'quick' => [
        ...
        'transfer_check' => [
            ...
            'no_transfer_data' => 'สมาชิกรายนี้ไม่มีบันทึกการแปลงโควต้าระหว่าง [: start_at ~: end_at]',
        ...
        'database_clean' => [
            ...
            'game_record' => 'Kỷ lục trò chơi thành viên',
    ...
    'send_fs' => [
        'msg' => [
            ...
            'send_success' => 'Giải phóng mặt bằng chống nước thành công',
            'send_fail' => 'Phân phối ngược nước không thành công:',
        ]
    ],
    ...
    'fs_level' => [
        'field' => [
            "game_type" => "Các loại trò chơi",
            "member_id" => "ID thành viên",
            "level" => "Mức độ chống nước",
            "name" => "Tên cấp bậc",
            "quota" => "Hạn mức cá cược hợp lệ",
            "type" => "Các loại",
            "rate" => "Tỷ lệ nước ngược",
            "lang" => "Ngôn ngữ/Đơn vị tiền tệ"
        ],
        ...
        'msg' => [
            ...
            'fs_level_repeat' => 'Dữ liệu cấp độ chống nước của cấp độ này đã tồn tại, vui lòng xóa nó sau khi hoạt động',
        ],
    ],
    ...
    'option' => [
        ...
        'activity_apply_field' => [
            ...
            'game_type' => 'Các loại trò chơi',
            'api_game_type' => 'Trò chơi phân loại',//(接口 + 游戏类型),
            'bill_no' => 'Số đĩa đơn',
        ],
        ...
        'member_money_type' => [
            'money' => 'Trung tâm ví số dư',
            'fs_money' => 'Số dư ví nước trở lại',
            'total_money' => 'Tổng số tiền đặt cược vào nền tảng',
        ...
        'member_log_type' => [
            ...
            5 => 'Tài liệu đặc vụ xuất hiện ở hậu trường',
        ...
        'fs_type' => [
            1 => 'Mức độ chống nước của hệ thống',
            2 => 'Cấp độ phản lực của thành viên'
        ],
        ...
        'agent_rate_type' => [
            ...
            4 => 'Dấu chấm mặc định trên đường dây của các đặc vụ'
        ],

        'config_money_type' => [
            'money' => 'Ví trung tâm',
            'fs_money' => 'Quay lại ví nước',
        ],
        ...
        'web_nav' => [
            ...
            "casino" => "Video trực tiếp",
            "lottery" => "Trò chơi xổ số",
            "sport" => "Sự kiện thể thao",
        ...
        'member_apis' => 'Giao diện cân bằng',
        'recharges' => 'Nạp tiền hồ sơ',
        'drawings' => 'Hồ sơ rút tiền',
        'transfers' => 'Hồ sơ chuyển tiền',
        'gamerecords' => 'Ghi chép trò chơi',
        'memberlogs' => 'Đăng nhập đăng nhập',
        'modify_money' => 'Thay đổi số dư',
        'arbitrage_query' => 'Truy vấn chứng khoán',
        'make_offline' => 'Kick off dòng',
    ...
    'api' => [
        ...
        'index' => [
            ...
            'main_advertise_title_2' => 'Giảm giá độc quyền trò chơi điện tử',
            'main_advertise_title_3' => 'Giảm giá độc quyền video trực tiếp',
            ...
            'hotgame_sub_title_1' => 'Cuộc thi chọi gà Thái Lan được bao phủ đầy đủ, cách chơi đa dạng và thú vị nhất, mang đến cho bạn những trò chơi giải trí chọi gà phong phú nhất trên toàn mạng。',
        ...
        'apply_agent' => [
            'member_is_agent' => 'Bạn đã là một đặc vụ，Không cần phải áp dụng cho',
            ...
            'status_fail' => 'Anh chưa nộp đơn xin ủy quyền',
            'not_agent' => 'Anh chưa phải là đặc vụ'
        ],
        ...
        'redbag' => [
            ...
            'success' => 'Xin chúc mừng，Lấy số tiền :money Phong bì màu đỏ，Hãy kiểm tra sổ sách trong hồ sơ giao dịch'
        ],
        ...
        'fs_now' => [
            'get_success' => 'Phản lực thời gian thực đã thành công，Hãy xem các chi tiết trong hồ sơ giao dịch',
            'fs_level_err' => 'Không có lớp chống nước，Xin vui lòng liên hệ với dịch vụ khách hàng',
            'fs_no_data' => 'Không có khoản giảm giá để yêu cầu',
            'fs_not_open' => 'Tính năng này chưa được mở',
            'fs_repeat' => 'Phần nước đọng này đã được thu gom, vui lòng không lặp lại thao tác'
        ],
        ...
        'transfer' => [
			...
			'change_error' => 'Không chuyển được, hiện chỉ hỗ trợ chuyển thủ công',
        ...
        'credit_pay' => [
            ...
            'money_not_enough' => 'Hãy đảm bảo tài khoản trung tâm có đủ tiền để trả nợ',
            'lend_success' => 'Trả nợ thành công'
        ],

        'game' => [
            'not_login' => 'Xin vui lòng đăng nhập',
            'no_api_code' => 'cầnapi_codeTham số',
            ...
            'api_code_not_exist' => 'Giao diện không tồn tại，Xin hãy kiểm tra',
            'api_code_not_open' => 'Giao diện không được mở，Hãy chọn trò chơi khác',
            'operate_fail' => 'Hoạt động thất bại，:msg Xin vui lòng liên hệ với dịch vụ khách hàng',
            'member_api_create_err' => 'Thành viên thành lập địa phươngAPITài khoản thất bại',
            'api_money_not_enough' => 'Giao diện cân bằng là không đủ，Xin vui lòng liên hệ với dịch vụ khách hàng',
            'member_money_not_enough' => 'Số dư tài khoản là không đủ，Không thể chuyển giao diện :money Đô la',
            ...
            'api_money_transfer_back_fail' => '【 :title】Giao diện trò chơi hoàn lại số tiền tài khoản hoạt động ngoại lệ，',
            'api_money_transfer_err' => 'Rẽ vào【 :title】Giao diện thất bại，Thông tin sai lệch:',
            'api_money_transfer_success' => 'Rẽ vào【 :title】Giao diện thành công',

            'transfer_out_error' => '【 :money】Giao diện cân bằng là không đủ，Biến trò chơi thất bại',
            'transfer_out_api_error' => 'Chuyển hạn ngạch giao diện [:title] ra khỏi trò chơi không thành công, thông báo lỗi:',
            'transfer_out_add_error' => 'Sau khi chuyển giao diện [:title], số tiền giao diện bị trừ và số tiền tài khoản người dùng tăng lên. Thao tác bất thường:',
        ...
        'agent_fd_rates' => [
            ...
            'child_rate_err' => 'Các loại trò chơi cấp dưới【 :game_type】Phản lực của nước không thể cao hơn chính nó【 :rate】',
            'top_rate_err' => 'Các loại trò chơi【 :game_type】Không thể thấp hơn điểm cao nhất của cấp dưới của đại lý【 :rate】',
            'agent_rate_err' => 'Các loại trò chơi【 :game_type】Phản lực của nước không thể cao hơn chính nó【 :rate】',
        ],
        ...
        'captcha' => [
            ...
            'out_of_date' => 'Captcha đã hết hạn，Làm lại thử lại đi',
        ],

        'task' => [
            'no_task' => 'Không có việc gì phải làm cả',
            'task_complete_title' => 'Thông báo nhiệm vụ hoàn thành',
            'task_complete_desc' => 'Chúc mừng anh đã hoàn thành nhiệm vụ【 :title】，Nhiệm vụ thưởng：',
            ...
            'week_award_title' => 'Trợ cấp cho anh chu',
    ...
    'configs' => [
        "is_redbag_open" => "Có mở phong bì đỏ hay không",
        "redbag_min_money" => "Số tiền phong bao lì xì tối thiểu",
        "redbag_max_money" => "Số tiền phong bì đỏ tối đa",
        "redbag_day_times" => "Số lượng phong bì đỏ mỗi ngày",
        ...
        "member_fs_money_type" => "Thành viên chống nước phát hành ví",
        "is_realtime_fs_mode" => "Có bật chế độ chống nước theo thời gian hay không",
        "activity_yuebao_plan_enable" => "Có mở gói Yu'ebao để mua hay không",
        "activity_yuebao_enable" => "Có mở Yu'ebao hay không",
        ...
        "levelup_slot_activity" => "Chi tiết về các hoạt động nâng cấp điện tử",
        "levelup_slot_example" => "Ví dụ về các hoạt động nâng cấp điện tử",
        "levelup_slot_level" => "Hướng dẫn nâng cấp điện tử",
        "levelup_slot_month" => "Mô tả tiền lương hàng tháng nâng cấp điện tử",
        ...
        "levelup_live_month" => "Giải thích về mức lương hàng tháng của người thực được nâng cấp",
        "app_tuiguang" => "Hướng dẫn quảng bá",
        "app_xima" => "Hướng dẫn rửa mã",
        "app_fanyong" => "Tỷ lệ hoàn lại",
        "app_xima_text" => "Hướng dẫn rửa mã",
        ...
        "service_link" => "Liên kết dịch vụ khách hàng",
        "service_line" => "Line",
        "service_line_pic" => "LineMã hai chiều",
        ...
        "service_logo_link" => "Liên kết nhảy LOGO",
    ...
    'agent_page' => [
        ...
        'title' => [
            ...
            'recharge_list' => 'Hồ sơ tiền gửi thành viên',
            'drawing_list' => 'Hồ sơ rút tiền của thành viên',
        ...
        'notice' => [
            'traditional_only' => 'Chỉ có chế độ đặc vụ truyền thống có thể truy cập trang này. Hiện tại, nó là chế độ điệp vụ quốc gia.',
            'allagent_only' => 'Chỉ có đặc vụ quốc gia có thể truy cập trang này. Hiện tại, nó là chế độ đặc vụ truyền thống.',
        ...
        'desc' => [
            ...
            'agent_default_rate' => 'Giảm giá mặc định của gián điệp',
        ],

        'field' => [
            'is_agent' => 'Đặc vụ hay không',
