...
class QuickUrl extends Model
{
    ...
    public static $list_field = [
        'name' => ['name' => 'Route ID', 'type' => 'text', 'is_show' => true],
        'title' => ['name' => 'Route Name', 'type' => 'text', 'is_show' => true],
        'desc' => ['name' => 'describe', 'type' => 'text', 'is_show' => true],
        'type' => ['name' => 'Route Type', 'type' => 'select', 'is_show' => true, 'data' => 'platform.quick_url_type'],
        'url' => ['name' => 'Routing Address', 'type' => 'text', 'is_show' => true],

        'is_open' => ['name' => 'Open', 'type' => 'radio', 'data' => 'platform.is_open', 'is_show' => true],
        'weight' => ['name' => 'Sorting', 'type' => 'number', 'is_show' => false]
    ];
