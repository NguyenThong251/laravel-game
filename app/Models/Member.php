...
class Member extends Authenticatable implements JWTSubject
{
    ...
    public static $list_field = [
        'name' => ['name' => 'username', 'type' => 'text', 'validate' => 'required', 'is_show' => false],
        'password' => ['name' => 'password', 'type' => 'password', 'validate' => 'required', 'is_show' => false],
        'original_password' => ['name' => 'APIpassword', 'type' => 'password', 'is_show' => false],
        'o_password' => ['name' => 'Original password', 'type' => 'password', 'is_show' => false],

        'nickname' => ['name' => 'Nick name', 'type' => 'text',  'is_show' => true],
        'realname' => ['name' => 'Real name', 'type' => 'text',  'is_show' => false],
        'email' => ['name' => 'e-mail', 'type' => 'text',  'is_show' => false],
        'phone' => ['name' => 'phone number', 'type' => 'text',  'is_show' => false],
        'qq' => ['name' => 'QQ Number', 'type' => 'text',  'is_show' => false],
        'line' => ['name' => 'Line', 'type' => 'text',  'is_show' => false],
        'facebook' => ['name' => 'FaceBook', 'type' => 'text',  'is_show' => false],

        'gender' => ['name' => 'gender', 'type' => 'radio',  'is_show' => false, 'data' => 'platform.gender'],
        'invite_code' => ['name' => 'Invite Code', 'type' => 'text',  'is_show' => false],
        'qk_pwd' => ['name' => 'Withdrawal password', 'type' => 'password', 'is_show' => false],

        'money' => ['name' => 'Center account balance', 'type' => 'number', 'is_show' => true],
        'fs_money' => ['name' => 'Rebate Account Balance', 'type' => 'number', 'is_show' => true],
        'total_money' => ['name' => 'Total bet amount on the platform', 'type' => 'number', 'is_show' => false],
        'score' => ['name' => 'integral', 'type' => 'number', 'is_show' => false],

        'register_ip' => ['name' => 'Register IP', 'type' => 'text', 'is_show' => true],
        'register_area' => ['name' => 'Registration Area', 'type' => 'text', 'is_show' => false],
        'register_site' => ['name' => 'Registration Channel', 'type' => 'text', 'is_show' => false],

        'status' => ['name' => 'state', 'type' => 'radio', 'is_show' => true, 'data' => 'platform.member_status', 'style' => 'platform.style_status'],
        // 'is_login' => ['name' => '是否登录', 'type' => 'radio', 'is_show' => true,'data' => 'platform.boolean','style' => 'platform.style_boolean'],
        'is_tips_on' => ['name' => 'Whether to enable login prompt', 'type' => 'radio', 'is_show' => false, 'data' => 'platform.boolean', 'style' => 'platform.style_boolean'],
        'is_in_on' => ['name' => 'Is it an internal account?', 'type' => 'radio', 'is_show' => true, 'data' => 'platform.boolean', 'style' => 'platform.style_boolean'],

        // top_id 表示该会员上级的代理（agent表中的）ID
        'top_id' => ['name' => 'Parent agent id', 'type' => 'text', 'is_show' => false],

        // agent_id 如果大于0表示该会员是代理，agent_id 对应的是 AGENT表中的ID
        'agent_id' => ['name' => 'Proxy ID', 'type' => 'text', 'is_show' => false],

        'lang' => ['name' => 'Language/Currency', 'type' => 'select', 'is_show' => true, 'data' => 'platform.lang_select']
    ];
    ...
    {
        return Member::withCount(['recharges as recharges_sum' => function ($query) {
