...
class MemberLog extends Model
{
    ...
    public static $list_field = [
        ...
        'ip' => ['name' => 'Operation IP', 'type' => 'text', 'is_show' => true],
        'address' => ['name' => 'IP real address', 'type' => 'text', 'is_show' => true],
        'ua' => ['name' => 'Operating Environment', 'type' => 'text', 'is_show' => false],
        'type' => ['name' => 'Operation Type', 'type' => 'select', 'is_show' => true, 'data' => 'platform.member_log_type'],
        // 'access_token' => ['name' => 'TOKEN','is_show' => ],
        'description' => ['name' => 'Operation Description', 'type' => 'text', 'is_show' => true],
        'remark' => ['name' => 'Remark', 'type' => 'text', 'is_show' => true],
    ];
