...
class GameRecord extends Model
{
    ...
    public static $list_field = [
        'billNo' => ['name' => 'Order serial number', 'type' => 'text', 'is_show' => true],
        'api_name' => ['name' => 'Interface ID', 'type' => 'text', 'is_show' => true],
        'name' => ['name' => 'Player Account', 'type' => 'text', 'is_show' => true],
        'gameType' => ['name' => 'Game Type', 'is_show' => true, 'type' => 'select', 'data' => 'platform.game_type'],
        'status' => ['name' => 'Settlement Status', 'is_show' => true, 'type' => 'select', 'data' => 'platform.gamerecord_status'],
        'betTime' => ['name' => 'Betting time', 'type' => 'text', 'is_show' => true],
        'betAmount' => ['name' => 'Bet Amount', 'type' => 'text', 'is_show' => true],
        'validBetAmount' => ['name' => 'Effective betting amount', 'type' => 'text', 'is_show' => true],
        'netAmount' => ['name' => 'Payout Amount', 'type' => 'text', 'is_show' => false],
        'roundNo' => ['name' => 'Session Information', 'type' => 'text', 'is_show' => false],
        'playDetail' => ['name' => 'Gameplay details', 'type' => 'text', 'is_show' => false],
        'wagerDetail' => ['name' => 'Betting Details', 'type' => 'text', 'is_show' => false],
        'gameResult' => ['name' => 'Lottery Results', 'type' => 'text', 'is_show' => false],
    ];
