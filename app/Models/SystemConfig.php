...
class SystemConfig extends Model
{
    ...
    public static $configTypeMap = [
        self::CONFIG_TYPE_TEXT => 'character',
        self::CONFIG_TYPE_TEXTAREA => 'paragraph',
        self::CONFIG_TYPE_PICTURE => 'picture',
        self::CONFIG_TYPE_TIME => 'Time Type',
        self::CONFIG_TYPE_URL => 'Link',
        self::CONFIG_TYPE_BOOLEAN => 'switch',
        self::CONFIG_TYPE_SELECT => 'Drop-down box',
        self::CONFIG_TYPE_NUMBER => 'number',
        self::CONFIG_TYPE_EDITOR => 'Rich Text',
        self::CONFIG_TYPE_FILE => 'document'
    ];
    ...
    public static $list_field = [
        'id' => 'ID',
        'name' => 'Configure English logo',
        'title' => 'Configuring Titles',
        'config_group' => 'Configuration Grouping',
        'type' => 'Configuration Type',
        'data_config' => 'Configuring Data Sources',
        'type_text' => 'Configuration Type Description',
        'value' => 'Configuration Values',
        'description' => 'Configuration Description',
        'weight' => 'Weight',
        'is_open' => 'Is it enabled?',
        'is_open_text' => 'Open description',
    ...
    const MULTI_LANGS_ARR = [
        ...
        'credit_borrow',
        'credit_lend',
        'levelup_slot_activity',
        'levelup_slot_example',
        'levelup_slot_level',
        'levelup_slot_month',
        'levelup_live_activity',
        'levelup_live_example',
        'levelup_live_level',
        'levelup_live_month',
        'app_tuiguang',
        'app_xima',
