...
class MemberMoneyLog extends Model
{
    ...
    public static $list_field = [
        ...
        'money' => ['name' => 'Operation amount', 'type' => 'number', 'validate' => 'required', 'is_show' => true],
        'money_before' => ['name' => 'Amount before operation', 'type' => 'number', 'is_show' => true],
        'money_after' => ['name' => 'Amount after operation', 'type' => 'number', 'is_show' => true],
        ...
        'number_type' => ['name' => 'Quantity Type', 'validate' => 'required', 'type' => 'radio', 'is_show' => true, 'data' => 'platform.money_number_type', 'style' => 'platform.money_number_style'],
        'operate_type' => ['name' => 'Amount change type', 'type' => 'select', 'is_show' => true, 'data' => 'platform.member_money_operate_type'],

        'model_name' => ['name' => 'Model Name', 'type' => 'text', 'is_show' => false],
        'model_id' => ['name' => 'Model ID', 'type' => 'number', 'is_show' => false],

        'description' => ['name' => 'Operation Description', 'type' => 'text', 'is_show' => true],
        'remark' => ['name' => 'Operation Notes', 'type' => 'text', 'is_show' => false],
